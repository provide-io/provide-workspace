...
The validation script verifies your provide-workenv setup:
...
# Verify activation
echo $VIRTUAL_ENV
# Should show: /path/to/provide-workenv/.venv
```
...
```bash
which python3
# Should point to: /path/to/provide-workenv/.venv/bin/python3
...
- **[Development Workflow](../guide/workflow.md)** - Start making changes
- **[Testing Guide](../testing/index.md)** - Run tests across packages
