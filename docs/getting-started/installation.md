...
Complete step-by-step guide for setting up the provide-workenv workspace.
...
Clone the provide-workenv repository to your local machine:
...
```bash
(.venv) user@host:~/provide-workenv$
```
...
alias activate-provide='source /path/to/provide-workenv/.venv/bin/activate'
```
...
Your provide-workenv workspace is now ready!

### Learn the Basics

- **[Development Workflow](../guide/workflow.md)** - Making changes and testing
...
3. Open an issue in [provide-workenv](https://github.com/provide-io/provide-workenv/issues)
