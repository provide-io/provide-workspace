...
:   provide-workenv coordinates these repositories, providing unified development environment and tooling.
...
See [Development Workflow](../guide/workflow.md) for practical examples.
...
| Feature | provide-workenv | Monorepo |
|---------|-----------------|----------|
...
| Feature | provide-workenv | Manual Individual |
|---------|-----------------|-------------------|
