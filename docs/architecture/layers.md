...
pip install -e ../provide-testkit

# 2. Framework Layer (depends on Foundation)
pip install -e ../pyvider-cty
pip install -e ../pyvider-hcl      # depends on pyvider-cty
pip install -e ../pyvider-rpcplugin
pip install -e ../pyvider           # depends on pyvider-cty
pip install -e ../pyvider-components # depends on all above

# 3. Tools Layer (depends on Foundation, optionally Framework)
pip install -e ../flavorpack
pip install -e ../wrknv
pip install -e ../plating
pip install -e ../tofusoup
pip install -e ../supsrc
```
...
- **[Development Workflow](../guide/workflow.md)** - Practical development patterns
