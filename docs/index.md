...
`provide-workenv` is the **official workspace management solution** for developing with the provide.io ecosystem. It orchestrates all 13+ repositories across three architectural layers (Foundation, Framework, Tools), providing a unified development environment with a single command.

Unlike traditional monorepos, provide-workenv uses a **meta-repository pattern** - each package maintains its own repository while the workspace provides coordination, shared tooling, and integrated development workflows.
...
provide-workenv manages the complete ecosystem:
...
-   :material-book-open: **[User Guide](guide/workflow.md)**
...
**provide-workenv** *uses* wrknv to manage the provide.io ecosystem

Think of wrknv as Make or Task, and provide-workenv as a specific Makefile configured for the provide.io ecosystem. You can use wrknv to create your own workspaces, and provide-workenv shows you how.

See [provide-workenv vs wrknv](reference/vs-wrknv.md) for detailed comparison.
...
3. **[Development Workflow](guide/workflow.md)** - Learn common development patterns
4. **[Architecture](architecture/index.md)** - Understand the meta-repository pattern

## Support

- **Issues**: [GitHub Issues](https://github.com/provide-io/provide-workenv/issues)
- **Discussions**: [GitHub Discussions](https://github.com/provide-io/provide-workenv/discussions)
